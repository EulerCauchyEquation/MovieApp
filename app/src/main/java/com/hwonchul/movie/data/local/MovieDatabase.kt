...
@Database(
    entities = [MovieEntity::class, MovieDetailEntity::class, VideoEntity::class, ImageEntity::class, MovieSearchRemoteKeyEntity::class, MovieListRemoteKeyEntity::class, FavoritesEntity::class],
    version = 1
)
